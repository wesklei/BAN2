 ...
 */
@Stateless
public class BibliografiacomplementarFacade extends AbstractFacade<Bibliografiacomplementar> {
    ...
    public BibliografiacomplementarFacade() {
        super(Bibliografiacomplementar.class);
    }
